...
export default function ProfilePage() {
  ...
  return (
    <div className="animate-fade-up max-w-7xl mx-auto md:grid md:grid-cols-12 gap-6 space-y-6 md:space-y-0">
      
      {/* Columna Izquierda (Perfil, Estadísticas, Logout) */}
      <div className="md:col-span-4 lg:col-span-3 space-y-6">
        {/* Card de perfil */}
        <div className="bg-white dark:bg-surface-card border border-slate-200 dark:border-surface-border rounded-2xl p-6 flex flex-col items-center text-center gap-4 shadow-sm dark:shadow-none">
          <div className="w-24 h-24 rounded-3xl bg-brand-100 dark:bg-brand-500/20 text-brand-600 dark:text-brand-400 flex items-center justify-center text-4xl font-black shrink-0 border-2 border-brand-200 dark:border-brand-500/30 overflow-hidden">
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            {[
              ...
              <div key={label} className="bg-slate-50 dark:bg-surface-hover rounded-xl p-3 border border-slate-100 dark:border-transparent flex flex-col items-center">
                ...
                <p className="text-[10px] sm:text-xs text-slate-500 dark:text-slate-400 mt-0.5">{label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="md:col-span-8 lg:col-span-9">
        {/* Logros */}
        <div className="bg-white dark:bg-surface-card border border-slate-200 dark:border-surface-border rounded-2xl p-5 shadow-sm dark:shadow-none h-full">
